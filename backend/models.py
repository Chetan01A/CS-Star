...
class UserSettings(Base):
    ...
    message_controls = Column(Boolean, default=True)
    message_request_audience = Column(String, default="everyone")
    group_invite_audience = Column(String, default="everyone")
    message_replies = Column(Boolean, default=True)
    story_reply_audience = Column(String, default="everyone")
    show_activity_status = Column(Boolean, default=True)
    tags_mentions = Column(Boolean, default=True)
    tag_audience = Column(String, default="everyone")
    mention_audience = Column(String, default="everyone")
    manual_tag_approval = Column(Boolean, default=False)
    comment_audience = Column(String, default="everyone")
    gif_comments_enabled = Column(Boolean, default=True)
    sharing_reuse = Column(Boolean, default=True)
    story_shares_enabled = Column(Boolean, default=True)
    posts_reels_to_stories_enabled = Column(Boolean, default=True)
    reposts_enabled = Column(Boolean, default=True)
    website_embeds_enabled = Column(Boolean, default=False)
    featured_content_requests_enabled = Column(Boolean, default=True)
